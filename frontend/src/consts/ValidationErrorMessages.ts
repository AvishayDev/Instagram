...
export const ValidationMessages ={
    ...
    STRONG_PASSWORD:'8 characters, 1 Capital, 1 Special: !,@,# etc.)',
    MATCH_PASSWORDS:"Passwords dosen't match",
    NAME_REQUIRED:'What is Your name again..?',
    LETTERS:' can be only letters'
}